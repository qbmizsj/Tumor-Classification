...
class CNN(nn.Module):
    def __init__(self, n_class):
        ...
        self.conv1 = nn.Sequential(nn.Conv2d(3, 32, kernel_size=11, stride=4, padding=0),
                                   #nn.BatchNorm2d(32),
                                   nn.ReLU(inplace=True),
                                   nn.MaxPool2d(kernel_size=3, stride=2, padding=0))

        self.conv2 = nn.Sequential(nn.Conv2d(32, 128, kernel_size=5, stride=1, padding=0),
                                   #nn.BatchNorm2d(128),
                                   nn.ReLU(inplace=True),
                                   nn.MaxPool2d(kernel_size=3, stride=2, padding=0))
        ...
        #img_mask: torch.Size([7, 3, 625, 672])
        #x0.shape: torch.Size([7, 64, 14, 15])
        #x1.shape: torch.Size([7, 13440])
        self.dropout = nn.Dropout(p=0.4)
        self.fc1 = nn.Linear(13440, 2056)
        self.bn1 = nn.BatchNorm1d(2056)
